...
class FormularioErgometria(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets={
            'paciente_ergo':forms.Select(attrs={'class':'form-control','style':'display:none;'}),
            'estudio':forms.Select(attrs={'class':'form-control','style':'display:none;'}),
            ...
            'ta_plana':forms.TextInput(attrs={'class':'form-control'}), 

...
class Antecedentes(models.Model):
    ...
    fecha_fcrv_hta = models.DateField(null = True, blank=True)
    fecha_fcrv_dta = models.DateField(null = True, blank=True)
    ...
    fecha_crm_hta = models.DateTimeField(null = True, blank=True)
    ...
    fecha_infarto_reciente = models.DateField(null = True, blank=True)
